...
HD_PWD='c:/users/hep/documents/universefactory/edit_cccd_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cccd_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cccd_v1_0.tcl
