proc create_ipi_design { offsetfile design_name } {
	...
	make_bd_intf_pins_external  [get_bd_intf_pins dcd_0/M00_AXIS]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins dcd_0/M00_AXIS_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins dcd_0/M00_AXIS_ARESETN]
...
connect_bd_intf_net [get_bd_intf_pins slave_1/S_AXI ] [get_bd_intf_pins dcd_0/M00_AXI]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_1/ACLK] [get_bd_pins dcd_0/M00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_1/ARESETN] [get_bd_pins dcd_0/M00_AXI_ARESETN]
	connect_bd_net -net init_axi_txn_11 [get_bd_ports M00_AXI_INIT_AXI_TXN] [get_bd_pins dcd_0/M00_AXI_INIT_AXI_TXN]
	connect_bd_net -net error_11 [get_bd_ports M00_AXI_ERROR] [get_bd_pins dcd_0/M00_AXI_ERROR]
	connect_bd_net -net txn_done_11 [get_bd_ports M00_AXI_TXN_DONE] [get_bd_pins dcd_0/M00_AXI_TXN_DONE]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/dcd_v1_0_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef dcd_v1_0_tb_include_vh_"
	puts $fp "`define dcd_v1_0_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/dcd_v1_0_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "dcd_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 dcd_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top dcd_v1_0_tb [get_filesets sim_1]
