...
HD_PWD='C:/Users/HEP/Documents/universefactory/ip_repo/edit_tdc_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdc_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdc_v1_0.tcl
