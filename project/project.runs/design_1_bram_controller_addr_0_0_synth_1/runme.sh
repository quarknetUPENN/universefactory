...
HD_PWD='C:/Users/HEP/Documents/universefactory/project/project.runs/design_1_bram_controller_addr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bram_controller_addr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bram_controller_addr_0_0.tcl
