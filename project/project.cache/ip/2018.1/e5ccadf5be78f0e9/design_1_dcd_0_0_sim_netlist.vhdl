...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0_M00_AXI is
  ...
  signal \^m00_axi_awaddr\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  signal sendstate_i_1_n_0 : STD_LOGIC;
  signal sendstate_reg_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_araddr[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \axi_araddr[6]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of axi_arvalid_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \axi_awaddr[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \axi_awaddr[6]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of axi_awvalid_i_1 : label is "soft_lutpair11";
...
\axi_araddr[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF80"
        ...
        port map (
      I0 => sendstate_reg_n_0,
      I1 => m00_axi_arready,
      I2 => \^m00_axi_arvalid\,
      I3 => \^m00_axi_araddr\(0),
      O => \axi_araddr[5]_i_1_n_0\
    );
\axi_araddr[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F40"
    )
        port map (
...
\axi_wdata[16]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0C0A0A0A"
        ...
        port map (
      I0 => \^m00_axi_wdata\(0),
      I1 => sendstate_reg_n_0,
      I2 => \axi_awaddr[6]_i_1_n_0\,
      I3 => m00_axi_wready,
      I4 => \^m00_axi_wvalid\,
...
sendstate_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \^m00_axi_awvalid\,
      I4 => m00_axi_awready,
      I5 => sendstate_reg_n_0,
      O => sendstate_i_1_n_0
    );
sendstate_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m00_axi_awaddr\ : STD_LOGIC_VECTOR ( 4 downto 3 );
  signal \^m00_axi_wdata\ : STD_LOGIC_VECTOR ( 25 downto 1 );
...
begin
  ...
  m00_axi_awaddr(5) <= \^m00_axi_awaddr\(4);
  m00_axi_awaddr(4 downto 3) <= \^m00_axi_awaddr\(4 downto 3);
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0
     port map (
      ...
      m00_axi_arready => m00_axi_arready,
      m00_axi_arvalid => m00_axi_arvalid,
      m00_axi_awaddr(1) => \^m00_axi_awaddr\(3),
