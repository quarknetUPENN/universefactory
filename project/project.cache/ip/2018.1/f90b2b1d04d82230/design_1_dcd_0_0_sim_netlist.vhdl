...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of axi_awvalid_i_1 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \axi_wdata[30]_i_1\ : label is "soft_lutpair11";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0_M00_AXIS is
  ...
  signal tx_done1_in : STD_LOGIC;
  signal tx_done_i_1_n_0 : STD_LOGIC;
  signal tx_done_reg_n_0 : STD_LOGIC;
  signal tx_en : STD_LOGIC;
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of FSM_sequential_mst_exec_state_reg : label is "INIT_COUNTER:01,SEND_STREAM:1,IDLE:0";
  attribute KEEP : string;
  ...
  attribute SOFT_HLUTNM of read_pointer : label is "soft_lutpair0";
...
read_pointer: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
tx_done_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E0E0E0E000A0A0A0"
    )
        port map (
      I0 => tx_done_reg_n_0,
      I1 => tx_done1_in,
      I2 => m00_axis_aresetn,
      I3 => \FSM_sequential_mst_exec_state_reg__0\,
      I4 => m00_axis_tready,
      I5 => \read_pointer_reg__0\(3),
      O => tx_done_i_1_n_0
    );
