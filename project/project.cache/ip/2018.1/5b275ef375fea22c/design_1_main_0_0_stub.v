...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk40, dtm_cmd_out, rst_n, dtm_cmd_in_p, 
  dtm_cmd_in_n, clkbx, dtm_hard_p, dtm_hard_n, dtm_data_out)
/* synthesis syn_black_box black_box_pad_pin="clk40,dtm_cmd_out,rst_n,dtm_cmd_in_p,dtm_cmd_in_n,clkbx,dtm_hard_p,dtm_hard_n,dtm_data_out[11:0]" */;
  input clk40;
  input dtm_cmd_out;
  input rst_n;
  output dtm_cmd_in_p;
