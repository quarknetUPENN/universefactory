...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0_M00_AXI is
  ...
  signal rcvstate : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \rcvstate[0]_i_1_n_0\ : STD_LOGIC;
...
\rcvstate[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\rcvstate_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
