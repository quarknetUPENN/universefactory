...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0_M00_AXI is
  ...
  signal \axi_awaddr[5]__0_i_1_n_0\ : STD_LOGIC;
  signal \axi_awaddr[6]__0_i_1_n_0\ : STD_LOGIC;
  signal \axi_awaddr[6]__0_i_3_n_0\ : STD_LOGIC;
  ...
  signal \sendstate_reg_n_0_[0]\ : STD_LOGIC;
  signal \sendstate_reg_n_0_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_araddr[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of axi_arvalid_i_1 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \axi_awaddr[6]__0_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \axi_wdata[16]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of axi_wvalid_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of error_reg_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \read_index[0]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of read_mismatch_i_1 : label is "soft_lutpair7";
...
\axi_araddr[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => m00_axi_arready,
      I1 => \^m00_axi_arvalid\,
      I2 => \sendstate_reg_n_0_[1]\,
      I3 => \sendstate_reg_n_0_[0]\,
      I4 => \^m00_axi_araddr\(0),
...
\axi_awaddr[5]__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \sendstate_reg_n_0_[0]\,
      I1 => \sendstate_reg_n_0_[1]\,
      O => \axi_awaddr[5]__0_i_1_n_0\
    );
\axi_awaddr[6]__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
      ...
      I1 => init_txn_ff,
      I2 => m00_axi_aresetn,
      O => \axi_awaddr[6]__0_i_1_n_0\
    );
\axi_awaddr[6]__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\axi_awaddr[6]__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => \sendstate_reg_n_0_[1]\,
      I1 => \sendstate_reg_n_0_[0]\,
      O => \axi_awaddr[6]__0_i_3_n_0\
    );
...
\axi_awaddr_reg[3]__0\: unisim.vcomponents.FDRE
     port map (
      C => m00_axi_aclk,
      CE => axi_awvalid0,
      D => \axi_awaddr[6]__0_i_3_n_0\,
      Q => m00_axi_awaddr(0),
      R => \axi_awaddr[6]__0_i_1_n_0\
    );
...
\axi_awaddr_reg[4]__0\: unisim.vcomponents.FDRE
     port map (
      C => m00_axi_aclk,
      CE => axi_awvalid0,
      D => \sendstate_reg_n_0_[0]\,
      Q => m00_axi_awaddr(1),
      R => \axi_awaddr[6]__0_i_1_n_0\
    );
...
\axi_awaddr_reg[5]__0\: unisim.vcomponents.FDRE
     port map (
      C => m00_axi_aclk,
      CE => axi_awvalid0,
      D => \axi_awaddr[5]__0_i_1_n_0\,
      Q => m00_axi_awaddr(2),
      R => \axi_awaddr[6]__0_i_1_n_0\
    );
...
\axi_awaddr_reg[6]__0\: unisim.vcomponents.FDRE
     port map (
      C => m00_axi_aclk,
      CE => axi_awvalid0,
      D => \axi_awaddr[6]__0_i_3_n_0\,
...
\sendstate[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \^m00_axi_awvalid\,
      I2 => m00_axi_awready,
      I3 => \axi_awaddr[6]__0_i_1_n_0\,
      I4 => \sendstate_reg_n_0_[1]\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m00_axi_araddr\ : STD_LOGIC_VECTOR ( 4 downto 3 );
...
begin
  ...
  m00_axi_araddr(4 downto 3) <= \^m00_axi_araddr\(4 downto 3);
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dcd_v1_0
     port map (
      m00_axi_aclk => m00_axi_aclk,
      m00_axi_araddr(1) => \^m00_axi_araddr\(3),
      m00_axi_araddr(0) => \^m00_axi_araddr\(4),
      m00_axi_aresetn => m00_axi_aresetn,
      m00_axi_arready => m00_axi_arready,
      m00_axi_arvalid => m00_axi_arvalid,
