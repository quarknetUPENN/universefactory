...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk40, dtm_cmd_out, rst_n, dtm_cmd_in_p, 
  ...
  done, received_data, datagood)
/* synthesis syn_black_box black_box_pad_pin="clk40,dtm_cmd_out,rst_n,dtm_cmd_in_p,dtm_cmd_in_n,clkbx_p,clkbx_n,dtm_hard_p,dtm_hard_n,dtm_data_out[11:0],trigger,field15[26:0],field6[159:0],done[1:0],received_data[158:0],datagood" */;
  input clk40;
  input dtm_cmd_out;
  input rst_n;
  output dtm_cmd_in_p;
